...
def main():
    ...
    constraints_of_action_generation = [
        ...
        "a-goal-holding and not holding and docked(1) and not nonfatal and not E2 and not fatal implies A",
        "a-goal-holding and not holding and docked(2) and not nonfatal and not E2 and not fatal implies A",
        # From P1 to P0
        ...
        "a-goal-at(0) and at(11) and assigned(1) and holding and not nonfatal implies B(11,1)",
        ...
        "a-goal-at(0) and at(11) and not nonfatal and not assigned(1) and holding and not fatal implies S(1)",
    ...
    enableness_of_actions = [
        ...
        "B(14,13) implies move4_fail(14,13)",
        "B(13,11) implies move4(13,11)",
        "B(13,11) implies move4_fail(13,11)",
        "B(11,1) implies move4(11,1)",
        "B(11,1) implies move4_fail(11,1)",
        ...
        # from undocked location P1 to docked location P0 (just pass P1)
        "B2(1,0) implies move3(1,0)",
        "B2(1,0) implies move3_fail(1,0)",
        "B2(1,0) implies move3_fail2(1,0)",
    ...
    action_specification = {
        ...
        "move1": "forall x,y. move1(x,y) and at(x) and docked(x) implies at(y) and not at(x) and not docked(x) and docked(y) and not assigned(x)",

        # move2: from docked station to non-docked station
        "move2": "forall x,y. move2(x,y) and at(x) and docked(x) implies at(y) and not at(x) and not docked(x) and not assigned(x)",

        # move3: from non-docked station to docked station
        "move3": "forall x,y. move3(x,y) and at(x) implies at(y) and not at(x) and docked(y) and not assigned(x)",
        # move4: from non-docked station to non-docked station
        "move4": "forall x,y. move4(x,y) and at(x) implies at(y) and not at(x) and not assigned(x)",
