...
def main():
    ...
    enableness_of_actions = [
        ...
        "forall p,y. C(p) and at(y) and not docked(y) and not equal(y,1) and equal(p,5) implies move5(y,p)",
    ...
    action_specification = {
        ...
        "dropoff": "forall w. dropoff(w,2) and holding(w) implies on(w,2) and not holding(w)",
